...
def test_post_tweet_sucesso(mock_client):
    ...
    with patch("integracao_apis.postagens_sociais.consumer_key", "fake"), patch(
        "integracao_apis.postagens_sociais.consumer_secret", "fake"
    ), patch("integracao_apis.postagens_sociais.access_token", "fake"), patch(
        "integracao_apis.postagens_sociais.access_token_secret", "fake"
    ):
