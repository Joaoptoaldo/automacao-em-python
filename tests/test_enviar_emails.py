...
def test_enviar_email_com_credenciais_mocks():
    ...
    with patch.object(email_module, 'USER', 'test@test.com'), \
         patch.object(email_module, 'PASS', 'secret'), \
...
def test_enviar_email_sem_credenciais():
    ...
    with patch.object(email_module, 'USER', None), \
         patch.object(email_module, 'PASS', None):
